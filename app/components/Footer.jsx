  ...
  return (
    <footer className="bg-black text-center py-10">
      <div className="text-white max-w-4xl mx-auto">
        <p className="text-sm mb-4">© 2023 ToraSense. All rights reserved.</p>
        <p className="text-sm mb-4">
          Contact us: <a href="tel:+441252811336" className="text-blue-400 hover:underline">+44 1252 811336</a> |{' '}
          <a href="mailto:info@torasense.com" className="text-blue-400 hover:underline">info@torasense.com</a>
        </p>
        <p className="text-sm mb-4">
